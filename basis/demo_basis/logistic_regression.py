...
tf.app.flags.DEFINE_string('checkpoint_path', os.path.dirname(os.path.abspath(__file__)) + '/checkpoints',
...
tf.app.flags.DEFINE_integer('batch_size', 10, 'Number of model clones to deploy.')
...
with graph.as_default():
    ...
    # 这里的contribute.layers内有很多已经封装好的层，可以直接调用
    ...
    with sess.as_default():
        ...
        writer = tf.summary.FileWriter(FLAGS.train_path, tf.get_default_graph())
